...
class hierro (models.Model):
    ...
    image = models.ImageField(upload_to = 'hierro/', default = 'gallery/static/images/no-img.jpg')
...
class propietario (models.Model):
    ...
    image = models.ImageField(upload_to = 'propietarios/', default = 'gallery/static/images/no-img.jpg')
